                    ...
                    <div class="span9">
                        <form class="form-horizontal row-fluid" action="student.php" method="post">
                                    ...
                                    if(isset($_POST['submit']))
                                        {$s=$_POST['title'];
                                            $sql="select * from librarylms.user where (RollNo='$s' or Name like '%$s%') and RollNo<>'ADMIN'";
                                        }
                                    else
                                        $sql="select * from librarylms.user where RollNo<>'ADMIN'";
                                    ...
                                    <tr>
                                      ...
                                      <td><?php echo $email ?></td>                                      
                                        ...
                                        <center>
                                           ...
                                           <!-- <?php echo $rollno; ?>" class="btn btn-danger">Remove</a  -->
                                      </center>
                                        </td>
                                    </tr>
                            <?php }} ?>
